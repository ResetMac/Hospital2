					...
					<div class="display-tc">
						<div class="row">
							<div class="col-md-8 animate-box">
								<h1 class="no-margin">Лаборатории</h1>
								<p>Каждая больница или поликлиника может иметь в своём рапоряжении одну или несколько лабораторий, заключая с ними контракт.</p>
							</div>
						</div>
					</div>
				</div>
...
// удаление записи
if($_GET['act'] == 'del'){
	$query = "DELETE FROM labs WHERE id=".$_POST['id'];
    $result = mysqli_query($connect, $query);
}
// добавление новой записи
if($_GET['todo'] == 'create'){
	$query = "	INSERT INTO labs(name, id_hospital) 
	            VALUES ('".$_POST['name']."',
	            		'".$_POST['id_hospital']."'
	            )";
	$result = mysqli_query($connect, $query);
...
if($_GET['act'] == 'edit'){
	...
	<div class="row" style="margin-bottom: 30px;">
	  	<div class="col-md-1"><p style="text-align: right;">Новая лаборатория: </p></div>
	  	<div class="col-md-1">
	...
	<?php
	$query = "SELECT id, name, id_hospital FROM labs";
	$result = mysqli_query($connect, $query);
	$i = 1;
