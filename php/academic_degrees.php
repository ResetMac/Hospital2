					...
					<div class="display-tc">
						<div class="row">
							<div class="col-md-8 animate-box">
								<h1 class="no-margin">Учёная степень</h1>
								<p>Каждый врач может обладать учёной степенью, определяющей его звание.</p>
							</div>
						</div>
					</div>
				</div>
...
// удаление записи
if($_GET['act'] == 'del'){
	$query = "DELETE FROM academic_degrees WHERE id=".$_POST['id'];
    $result = mysqli_query($connect, $query);
}
// добавление новой записи
if($_GET['todo'] == 'create'){
	$query = "	INSERT INTO academic_degrees(name) 
	            VALUES ('".$_POST['name']."'
	            )";
	$result = mysqli_query($connect, $query);
}
	...
	<div class="col-md-6">
		<form action="<?=$_SERVER['PHP_SELF']?>?todo=create" method="POST">
			<div class="form-group">
				<label for="name">Название учёной степени</label>
...
if($_GET['act'] == 'edit'){
	...
	<div class="row" style="margin-bottom: 30px;">
	  	<div class="col-md-1"><p style="text-align: right;">Новая учёная степень: </p></div>
	  	<div class="col-md-1">
