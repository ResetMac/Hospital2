					...
					<div class="display-tc">
						<div class="row">
							<div class="col-md-8 animate-box">
								<h1 class="no-margin">Отличительные особенности категорий</h1>
								<p>Некоторые категории врачей обладают определёнными особенностями, выделяющими их из ряда прочих.</p>
							</div>
						</div>
					</div>
				</div>
...
// удаление записи
if($_GET['act'] == 'del'){
	$query = "DELETE FROM features WHERE id=".$_POST['id'];
...
if($_GET['act'] == 'edit'){
	...
	<div class="row" style="margin-bottom: 30px;">
	  	<div class="col-md-1"><p style="text-align: right;">Новая особенность: </p></div>
	  	<div class="col-md-1">
